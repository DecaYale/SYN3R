...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        image_latents = self._encode_vae_image(image[0:1,:,:,:], device, num_videos_per_prompt, do_classifier_free_guidance) # [2, 4, 72, 128] #NOTE: 2 is for unconditional and conditional, the first batch is all-zero tensor for unconditional
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.step_single_dgs_prob(noise_pred, t, latents,temp_cond_latents,mask,lambda_ts,step_i=i).prev_sample
