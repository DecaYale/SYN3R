...
for seq_name in $(ls $dataset_root); do
    ...
    GS_args="-s ${dataset_root}/${seq_name} --model_path ${workspace}/${seq_name}  --eval  --n_views 24 --depth_pseudo_weight 0.03  --sample_pseudo_interval 100000000000000  --sample_svd_pseudo_interval 100000000000000
