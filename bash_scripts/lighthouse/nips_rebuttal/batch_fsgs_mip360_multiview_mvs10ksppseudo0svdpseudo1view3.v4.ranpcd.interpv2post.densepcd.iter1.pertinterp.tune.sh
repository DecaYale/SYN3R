...
# for seq_name in "${reversed[@]}"; do
    ...
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v6_.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProbUncertain" --interp_type "backward_warp" --cam_confidence 0.2 --pseudo_cam_sampling_rate 0.02  --densify_type "interpolate_gs_v2"  --dataset "dl3dv" --lpips_weight 1 --svd_l1_weight 0 --refine_cycle_num 1 $GS_args | tee ${workspace}/${seq_name}/log.txt 2>&1
