...
for seq_name in "${seq[@]}"; do
    ...
    GS_args="-s ${dataset_root}/${seq_name} --model_path ${workspace}/${seq_name}  --eval  --n_views 3 --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 1  
        --num_train_samples 3 --images images --resolution 4
        "
    ...
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v2.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "1PassProb" --interp_type "backward_warp" --cam_confidence 0.05 --pseudo_cam_sampling_rate 0.02 --densify_type "from_single_gs" $GS_args 
    # python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v2.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "1Pass" --interp_type "backward_warp" --cam_confidence 0.05 --pseudo_cam_sampling_rate 0.02 --densify_type "from_single_gs" $GS_args 
