...
# for seq_name in "${seq[@]}"; do
    ...
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2Pass" --interp_type "backward_warp" --cam_confidence 0.05 --pseudo_cam_sampling_rate 0.02 --densify_type "from_single" $GS_args 
