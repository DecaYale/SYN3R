...
for seq_name in "${seq[@]}"; do
    ...
    # cp -a ${pretrained_root}/${seq_npame}/*.pt ${workspace}/${seq_name}/ # cp nvs files
    ...
    GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views $n_views --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 1
        ...
        "
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v4.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProb" --interp_type "backward_warp" --cam_confidence 0.2 --pseudo_cam_sampling_rate 0.02  --densify_type "interpolate_gs_v2"  --dataset "dl3dv" --lpips_weight 1 $GS_args 
