...
for seq_name in "${seq[@]}"; do
    ...
    GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views $n_views --sample_pseudo_interval 10 --sample_svd_pseudo_interval 1
        --num_train_samples $n_views --images images_4 --resolution 1 --use_proximity_densify 0 --densify_grad_threshold 0.0002  --percent_dense 0.001  --svd_depth_warmup 1 --use_dust3r 1  --start_sample_svd_frame 100 
        "
