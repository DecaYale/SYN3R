...
seq=("0a78c25f77c1ba1d1a3f07c18c9735ae1254a9a71290734b8836eefbefaadbc7")
...
for seq_name in "${seq[@]}"; do
    ...
    #     --num_train_samples $n_views --images images_4 --resolution 1
    #     "
    ...
    GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views ${n_views} --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 100000000000000000000
        ...
        "
    # GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views ${n_views} --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 100000000000000000000
    #     --num_train_samples $n_views --images images_4 --resolution 1 --use_proximity_densify 0 --densify_grad_threshold 0.0002
    #     "
    ...
    echo $GS_args
    # python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v4.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProb" --interp_type "backward_warp" --cam_confidence 0.1 --pseudo_cam_sampling_rate 0.02  --densify_type "interpolate_gs"  --dataset "dl3dv" --lpips_weight 1 $GS_args 
