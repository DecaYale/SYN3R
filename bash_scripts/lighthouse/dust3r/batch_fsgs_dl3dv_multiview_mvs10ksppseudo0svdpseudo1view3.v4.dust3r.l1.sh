...
# pretrained_root="/home/yxumich/Projects/NVS_Solver/output/FSGS/batch_dl3dv_sppseudo0svdpseudo1frmsingle1.midasGS.v4.6view.tune"
...
pretrained_root="/home/yxumich/Projects/NVS_Solver/output/FSGS/dus3r/batch_fsgs_dl3dv_sppseudo0svdpseudo1view${n_views}.v4.dust3r.fix"
...
for seq_name in "${seq[@]}"; do
    ...
    GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views $n_views --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 1
        --num_train_samples $n_views --images images_4 --resolution 1 --use_proximity_densify 0 --densify_grad_threshold 0.0002  --percent_dense 0.001  --svd_depth_warmup 1 --use_dust3r 1
        "
    # python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v4.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProb" --interp_type "backward_warp" --cam_confidence 0.2 --pseudo_cam_sampling_rate 1  --densify_type "interpolate_gs"  --dataset "dl3dv" --lpips_weight 1 --svd_l1_weight 1 $GS_args 
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v4.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProb" --interp_type "backward_warp" --cam_confidence 0.5 --pseudo_cam_sampling_rate 1  --densify_type "interpolate_gs"  --dataset "dl3dv" --lpips_weight 0.5 --svd_l1_weight 0.4 $GS_args 
