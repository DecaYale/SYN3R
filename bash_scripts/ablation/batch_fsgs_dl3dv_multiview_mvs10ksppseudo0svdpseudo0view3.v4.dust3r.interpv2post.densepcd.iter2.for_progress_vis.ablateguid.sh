...
# 9daa05c4182bb2ea065d280d4f510929d8e9c6d6e18a0782031c7c805cb822ec
# 9e4da70fe0be5d28ea7b375291bbf5523246345d807aa47d5208c6e6c2f5694c
# b12e9c2b9b01c1f32aa55567dde42cb831ff6647ee469376677ee890ae36864e
...
# for seq_name in "${reversed[@]}"; do
    ...
    #     "
    GS_args="-s ${dataset_root}/${seq_name}/${view_dir} --model_path ${workspace}/${seq_name}  --eval  --n_views $n_views --sample_pseudo_interval 100000000000000000000 --sample_svd_pseudo_interval 1
        --num_train_samples $n_views --images images_4 --resolution 1 --use_proximity_densify 0 --densify_grad_threshold 0.0002  --percent_dense 0.001  --svd_depth_warmup 1 --use_dust3r 0  --start_sample_svd_frame 2000 
        "
    ...
    python scripts/GSNVS_solver_multiview_2pass2latent_fsgs_v5_ablateguid.py  --iteration dgs1  --weight_clamp 0.2 --diffusion_type "2PassProbUncertainPost" --interp_type "backward_warp" --cam_confidence 0.2 --pseudo_cam_sampling_rate 0.02  --densify_type "interpolate_gs"  --dataset "dl3dv" --lpips_weight 1 --svd_l1_weight 0 --refine_cycle_num 2 $GS_args 
