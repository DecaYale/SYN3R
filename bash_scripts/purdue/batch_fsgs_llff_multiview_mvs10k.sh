...
export PYTHONPATH="/home/x-yxu14/Projects/NVS_Solver/":$PYTHONPATH
export PYTHONPATH="/home/x-yxu14/Projects/NVS_Solver/FSGS":$PYTHONPATH
##################DGS MODE#################
########## GS ##########

dataset_root="/home/x-yxu14/durable/datasets/nerf_llff_data/"
...
# for seq_name in "${seq[@]}"; do
    ...
    #         "
    GS_args="-s ${dataset_root}/${seq_name} --model_path ${workspace}/${seq_name}  --eval  --n_views 3 --sample_pseudo_interval 1 
        --num_train_samples 3
        "
